...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 入住管理 <span class="c-gray en">&gt;</span> 入住管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
        ...
        table.on('tool(test)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layer.confirm('真的要结算吗', function(index){
                    layer_show("入住结算", "${basePath}/sys/comment/getonecomment.action?id="+data.id, "500", "300");
                });
